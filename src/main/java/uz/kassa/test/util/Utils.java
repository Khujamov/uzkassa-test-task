...
public class Utils {
  ...
  public static String nextAlpha() {
    for (int idx = 0; idx < buf.length; ++idx)
      buf[idx] = ALPHA.charAt(random.nextInt(ALPHANUMERIC.length()));
  ...
  public static String nextNumeric() {
    for (int idx = 0; idx < buf.length; ++idx)
      buf[idx] = NUMERIC.charAt(random.nextInt(NUMERIC.length()));
    return new String(buf);
  }

  public static final String CONFIRM_URL = "http://localhost:8183/v1/api/auth/activate?token=";
